...
exports.initPropertyTable = async function () {
  try {
...
exports.updatePropertyTable = async function () {
  try {
    ...
    logger.error(
      "setupPropertyTable, updatePropertyTable function, an error happened while reading table data from file. the Error is ",
      error
    );
    return 1;
  }
